...
public class AdminBlogController {
    ...
    public String searchBlog(SearchBlog search,Model model){
        ...
        if ("recycle".equals(search.getRecognize())){
            ...
            if (search.getSearchtitle() != null && !search.getSearchtitle().equals("") || search.getSearchtypeid() != null && !search.getSearchtypeid().equals("0") || search.isRealsearchrecommend() != null){
                //通过各种查询
