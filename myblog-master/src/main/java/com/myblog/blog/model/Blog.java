...
public class Blog {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstpicture, createtime, updatetime, typeid, tagid, nature, title, view, description, stick, recommend, reprint, supportreview, admire, content, recycle, recordlife, sort, password, type);
    }
