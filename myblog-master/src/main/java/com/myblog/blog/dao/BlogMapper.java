...
public interface BlogMapper {
    ...
    //回收站的查询功能
    List selectBlogByTitleFromRecycle(@Param("searchtitle") String searchtitle, @Param("typeid") String typeid, @Param("realsearchrecommend") Boolean realsearchrecommend);
    ...
    Integer selectBlogisEncrypted(Long valueOf);

    Integer selectBlogEncryption(@Param("code") String code,@Param("blogid") Long blogId);

    List<Blog> selectBlogByVarious(SearchBlog search);

    Blog selectBlogRemoveContentByBlogId(Long blogid);

    int updateBlogPasswordByBlogID(@Param("blogid") Long blogid, @Param("password") String password);
}