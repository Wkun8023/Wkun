...
public class BlogServiceImp implements BlogService{
    ...
    @Override
    public Integer queryBlogIsEncrypted(String id) {
    ...
    public Integer queryBlogEncryption(String code,Long blogId) {
        ...
        return blogDao.selectBlogEncryption(code,blogId);
    }
    ...
    public List queryBlogByTitleFromRecycle(SearchBlog search){
        return blogDao.selectBlogByTitleFromRecycle(search.getSearchtitle(),search.getSearchtypeid(),search.isRealsearchrecommend());
    }
